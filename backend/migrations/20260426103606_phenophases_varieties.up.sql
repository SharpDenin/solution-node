...
VALUES
    ('Gala', 'Популярный сладкий сорт яблони с красно-жёлтой окраской.', 'low'),
    ('Fuji', 'Сладкий и хрустящий сорт яблони японского происхождения.', 'high'),
    ('Granny Smith', 'Зелёный кислый сорт яблони, хорошо известный для свежего употребления и кулинарии.', 'low'),
